        ...
        <CardBody>
          ...
          <div className="tileGridContainer">
           <div className="tileText">
            ...
            <div className="tileImage"><img src={props.post.imageUrl} width="200px" height="200px"/></div>
          </div>
          <div className="cardFooter">
            <div style={{"padding": "8px", "backgroundColor": "aliceblue", "borderRadius": "10%" }}>{props.post.category}</div>
